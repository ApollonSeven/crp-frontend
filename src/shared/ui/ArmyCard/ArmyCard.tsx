        ...
        <div className={stylesBase.cardShape}>
            <div className={stylesBase.header}>
                ...
                <div className={stylesBase.logo}>
                    <div className={stylesBase.mediumText}>Armed Forces of the United States</div>
            ...
            <div className={stylesBase.name}>
                <div className={stylesBase.largeText}>{props.firstName?.toUpperCase()}</div>
                <div className={stylesBase.largeText}>{props.lastName?.toUpperCase()}</div>
            </div>
            <div className={stylesBase.info}>
                ...
                <div className={stylesBase.grade}>
                    <div>
                        ...
                        <div className={stylesBase.mediumText}>{props.pavGrade}</div>
                    </div>
                ...
                <div className={stylesBase.rank}>
                    <div>
                        ...
                        <div className={stylesBase.mediumText}>{props.rank}</div>
                    </div>
                    <div className={stylesBase.date_date}>
                        <div className={stylesBase.largeText}>Issue Date</div>
                        <div className={stylesBase.largeText}>{props.issueDate}</div>
                        <div className={stylesBase.largeText}>Expiration Date</div>
                        <div className={stylesBase.largeText}>{props.expirationDate}</div>
                    </div>
                </div>
            </div>
